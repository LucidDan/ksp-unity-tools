...
{
    [InitializeOnLoad]
    public class TextMeshProResolver
    {
        private const string TextMeshProDir = "KSPPartTools/TextMesh Pro/Plugins";
        // We currently require this specific version because KSPAssetCompiler
        //  is compiled for that.
        private const string TextMeshProDllFilter = "TextMeshPro-2017.1-1.0.56*.dll";
        ...
        private static bool GetPathToTMP(out string path)
        {
            ...
            var tmpDir = SanitizePath(Path.Combine(Application.dataPath, TextMeshProDir));
